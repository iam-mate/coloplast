...
<div class="wrapper">
    ...
    <div class="popup reg-adr">
        <div class="popup__header">
            <button class="popup__close" onclick="popup.close()">닫기</button>
            <div class="popup__logo">
                <img src="/html/images/logo.png" class="popup__logo-img" alt="">
            </div>
            <h1 class="popup__title">배송지 등록</h1>
        </div>
        <div class="popup__body">
            <form action="">
                <div class="form form--form">
                    ...
                    <div class="form__row">
                        <h2 class="form__title">
                            <label for="name2">* 보호자/수령인</label>
                        </h2>
                        <div class="input form__input">
                            <input type="text" id="name2">
                        </div>
                        <label class="checkbox" for="sameName">
                            <input type="checkbox" class="checkbox__input blind" id="sameName">
                            <span class="checkbox__icon"></span> 사용자와 동일
                        </label>
                    </div>
                    <div class="form__row form__row--margintop">
                        <h2 class="form__title">
                            <label for="number">* 연락처</label>
                        </h2>
                        <div class="input form__input">
                            <input type="text" id="number" placeholder="'-' 를 빼고 입력해주세요.">
                        </div>
                    </div>
                    <div class="form__row">
                        <h2 class="form__title">
                            <label for="adr">* 배송지</label>
                        </h2>
                        <div class="input form__input form__input--add-btn clearfix">
                            <input type="text" id="adr" class="float-left" disabled>
                            <button type="button" class="btn btn--input btn--gray float-left">우편번호 검색</button>
                        </div>
                        <div class="input form__input">
                            <input type="text" id="adr1" disabled>
                        </div>
                        <div class="input form__input">
        ...
        <div class="popup__footer">
            <div class="btnbox">
                <button type="submit" class="btn btn--blue btn--full">등록</button>
            </div>
        </div>
    </div>
    <!-- 카카오 팝업 -->
